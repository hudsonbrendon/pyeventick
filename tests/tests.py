...
class TestEventick(unittest.TestCase):
    ...
    def test_events(self):
        self.assertEqual(self.eventick.events()['events'][0]['title'], 'Event test')

    def test_event(self):
        self.assertEqual(self.eventick.event(21091)['events'][0]['title'], 'Event test')

    def test_attendees(self):
        self.assertEqual(self.eventick.attendees(21091)['attendees'][0]['code'], 'JR2VIBIN')

    def test_attendee(self):
        self.assertEqual(self.eventick.attendee(21091, 911536)['attendees'][0]['code'], 'XWD2I1LH')

    def test_checkin(self):
        self.assertEqual(self.eventick.checkin(21091, 'XWD2I1LH', '2012-10-17T16:54:35-03:00'), 204)
        self.assertEqual(self.eventick.attendee(21091, 911536)['attendees'][0]['checked_at'], '2012-10-17 16:54:35 -0300')

    def test_checkin_all(self):
        self.assertEqual(self.eventick.checkin_all(21091, {"attendees":[{"id":911697,"checked_at":"2012-10-17T16:54:35-03:00"}, {"id":911536,"checked_at":"2012-10-17T16:54:35-03:00"}]}), 200)
        self.assertEqual(self.eventick.attendee(21091, 911697)['attendees'][0]['checked_at'], '2012-10-17 16:54:35 -0300')
        self.assertEqual(self.eventick.attendee(21091, 911536)['attendees'][0]['checked_at'], '2012-10-17 16:54:35 -0300')
